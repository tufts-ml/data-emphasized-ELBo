...
if __name__=='__main__':
    ...
    parser.add_argument('--model_arch', default='', help='TODO', type=str)
    ...
    parser.add_argument('--prior_directory', default='', help='TODO', type=str)
    parser.add_argument('--prior_type', default='', help='TODO', type=str)
    ...
    augmented_train_loader = torch.utils.data.DataLoader(tokenized_datasets['train'], batch_size=32, shuffle=True)
    train_loader = torch.utils.data.DataLoader(tokenized_datasets['train'], batch_size=32)
    val_or_test_loader = torch.utils.data.DataLoader(tokenized_datasets['val_or_test'], batch_size=32)
