...
if __name__=="__main__":
    ...
    la_train_dataloader = torch.utils.data.DataLoader(train_dataset, batch_size=args.la_batch_size, num_workers=args.num_workers)
    ...
    if args.model_arch == "ConvNeXt-Tiny":
        # Note: Replacing LayerNorm2d and CNBlock with mathematically equivalent layers for diagEF LA-LML.
        with torch.no_grad():
