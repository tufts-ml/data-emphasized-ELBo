...
# python main_CIFAR-10.py --dataset_directory='/cluster/tufts/hugheslab/eharve06/CIFAR-10' --experiments_directory='/cluster/home/eharve06/informed-priors/experiments/test' --kappa=23528.522 --lr_0=0.001 --N=1000 --model_name='l2-sp_kappa=d_over_n_lr_0=0.001_n=1000_random_state=1001' --prior_directory='/cluster/tufts/hugheslab/eharve06/resnet50_torchvision' --prior_type='l2-sp' --random_state=1001 --wandb --wandb_project='retrained_CIFAR-10_VPE'
if __name__=='__main__':
    ...
    augmented_train_dataset, train_dataset, val_or_test_dataset = utils.get_cifar10_datasets(root=args.dataset_directory, n=args.N, tune=args.tune, random_state=args.random_state)
