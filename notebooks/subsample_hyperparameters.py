...
if __name__=='__main__':
    ...
    tuned_df = pd.read_csv('/cluster/tufts/hugheslab/eharve06/data-emphasized-ELBo/notebooks/tuned_CIFAR-10_ConvNeXt-Tiny_CLML2.csv')
    retrained_df = pd.read_csv('/cluster/tufts/hugheslab/eharve06/data-emphasized-ELBo/notebooks/retrained_CIFAR-10_ConvNeXt-Tiny_CLML2.csv')
