...
if __name__=='__main__':
    #tuned_df = pd.read_csv('{root_directory}/data-emphasized-ELBo/notebooks/tuned_CIFAR-10_ConvNeXt_Tiny.csv')
    #retrained_df = pd.read_csv('{root_directory}/data-emphasized-ELBo/notebooks/retrained_CIFAR-10_ConvNeXt_Tiny.csv')
    #cifar10_dictionary = subsample_hyperparameters([100, 1000, 10000, 50000], retrained_df, tuned_df)
    #np.save('{root_directory}/data-emphasized-ELBo/notebooks/CIFAR-10_ConvNeXt_Tiny_dictionary.npy', cifar10_dictionary)
    
    tuned_df = pd.read_csv('{root_directory}/data-emphasized-ELBo/notebooks/tuned_Oxford-IIIT_Pet_ConvNeXt_Tiny.csv')
    retrained_df = pd.read_csv('{root_directory}/data-emphasized-ELBo/notebooks/retrained_Oxford-IIIT_Pet_ConvNeXt_Tiny.csv')
    oxfordiiit_pet_dictionary = subsample_hyperparameters([370, 3441], retrained_df, tuned_df)
    np.save('{root_directory}/data-emphasized-ELBo/notebooks/Oxford-IIIT_Pet_ConvNeXt_Tiny_dictionary.npy', oxfordiiit_pet_dictionary)
    
    #tuned_df = pd.read_csv('{root_directory}/data-emphasized-ELBo/notebooks/tuned_Flowers_102_ConvNeXt_Tiny.csv')
    #retrained_df = pd.read_csv('{root_directory}/data-emphasized-ELBo/notebooks/retrained_Flowers_102_ConvNeXt_Tiny.csv')
    #flowers_102_dictionary = subsample_hyperparameters([510, 1020], retrained_df, tuned_df)
    #np.save('{root_directory}/data-emphasized-ELBo/notebooks/Flowers_102_ConvNeXt_Tiny_dictionary.npy', flowers_102_dictionary)
