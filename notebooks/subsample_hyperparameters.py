...
if __name__=='__main__':
    ...
    #tuned_oxfordiiit_pet_df = pd.read_csv('/cluster/tufts/hugheslab/eharve06/data-emphasized-ELBo/notebooks/tuned_Oxford-IIIT_Pet.csv')
    #retrained_oxfordiiit_pet_df = pd.read_csv('/cluster/tufts/hugheslab/eharve06/data-emphasized-ELBo/notebooks/retrained_Oxford-IIIT_Pet.csv')
    #oxfordiiit_pet_dictionary = subsample_hyperparameters([370, 3441], retrained_oxfordiiit_pet_df, tuned_oxfordiiit_pet_df)
    #np.save('/cluster/tufts/hugheslab/eharve06/data-emphasized-ELBo/notebooks/Oxford-IIIT_Pet_ResNet_50_dictionary.npy', oxfordiiit_pet_dictionary)
    tuned_flowers_102_df = pd.read_csv('/cluster/tufts/hugheslab/eharve06/data-emphasized-ELBo/notebooks/tuned_Flowers_102_ResNet_50.csv')
    retrained_flowers_102_df = pd.read_csv('/cluster/tufts/hugheslab/eharve06/data-emphasized-ELBo/notebooks/retrained_Flowers_102_ResNet_50.csv')
    flowers_102_dictionary = subsample_hyperparameters([510, 1020], retrained_flowers_102_df, tuned_flowers_102_df)
    np.save('/cluster/tufts/hugheslab/eharve06/data-emphasized-ELBo/notebooks/Flowers_102_ResNet_50_dictionary.npy', flowers_102_dictionary)