...
if __name__=='__main__':
    tuned_cifar10_df = pd.read_csv('/cluster/tufts/hugheslab/eharve06/data-emphasized-ELBo/notebooks/tuned_CIFAR-10.csv')
    retrained_cifar10_df = pd.read_csv('/cluster/tufts/hugheslab/eharve06/data-emphasized-ELBo/notebooks/retrained_CIFAR-10.csv')
    cifar10_dictionary = subsample_hyperparameters([100, 1000, 10000, 50000], retrained_cifar10_df, tuned_cifar10_df)
    np.save('/cluster/tufts/hugheslab/eharve06/data-emphasized-ELBo/notebooks/CIFAR-10_dictionary.npy', cifar10_dictionary)
    ...
    #np.save('/cluster/tufts/hugheslab/eharve06/data-emphasized-ELBo/notebooks/Oxford-IIIT_Pet_dictionary.npy', oxfordiiit_pet_dictionary)